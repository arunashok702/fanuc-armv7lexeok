...
// Check if FWLIBAPI and WINAPI are defined, if not, define them
#ifndef FWLIBAPI
#define FWLIBAPI
#endif
...
// Declare the functions with the appropriate macros
extern "C" {
    FWLIBAPI short WINAPI cnc_startupprocess(long, char*);
    FWLIBAPI void WINAPI cnc_exitprocess();
}
